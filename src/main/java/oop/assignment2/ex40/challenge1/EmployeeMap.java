...
public class EmployeeMap {
    ...
    public void printSearchMap (Map<String, Employee> employeeMap, String search){
        ...
        for(String x: sortedKeys){
            ...
            String firstName = employeeMap.get(x).getFirstName().toLowerCase();
            String lastName = employeeMap.get(x).getLastName().toLowerCase();

            if(lastName.contains(search) || firstName.contains(search)){
